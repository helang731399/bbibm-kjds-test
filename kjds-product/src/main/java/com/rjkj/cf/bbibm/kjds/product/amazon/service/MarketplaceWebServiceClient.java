...
public  class MarketplaceWebServiceClient implements MarketplaceWebService {
    ...
    static {
        try {
            jaxbContext = JAXBContext.newInstance("com.rjkj.cf.bbibm.kjds.product.amazon.model", MarketplaceWebService.class.getClassLoader());
                ...
                try {
                    ...
                    if (status == HttpStatus.SC_OK && responseBodyString != null) {
                        ...
                        if (status == HttpStatus.SC_INTERNAL_SERVER_ERROR
                            ...
                            com.rjkj.cf.bbibm.kjds.product.amazon.model.Error error = errorResponse.getError().get(0);
    ...
    public static String computeContentMD5HeaderValues( FileInputStream fis )
    	    throws IOException, NoSuchAlgorithmException {
